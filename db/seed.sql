...
TRUNCATE TABLE order_items, orders, watch_images, watches,
case_materials, movements, categories, brands, user_addresses, users
...
(
    ...
    2850000.00,
    3200000.00,
    '/assets/pexels-6230456.jpeg',
    '300m',
    '5 Years',
    '41mm',
    'The Rolex Submariner is the reference among divers'' watches.',
    5,
    4.90,
    128,
    TRUE,
...
(
    ...
    850000.00,
    95000.00,
    '/assets/pexels-207489.jpeg',
    '200m',
    '2 Years',
    '48mm',
    'The ultimate sports watch with solar charging and GPS.',
    25,
    4.70,
    342,
    TRUE,
...
(
    ...
    4200000.00,
    NULL,
    '/assets/pexels-15261585.jpeg',
    '30m',
    '2 Years',
    '43mm',
    'Classic pilot watch with a slide rule bezel for navigation.',
    3,
    4.90,
    78,
    TRUE,
...
(
    ...
    195000.00,
    NULL,
    '/assets/pexels-218675.jpeg',
    '100m',
    '1 Year',
    '47mm',
    'Advanced GPS multisport smartwatch with sapphire lens.',
    20,
    4.80,
    421,
    TRUE,
...
(
    ...
    185000.00,
    NULL,
    '/assets/pexels-277955.jpeg',
    '100m',
    '2 Years',
    '40mm',
    'Sporty elegance with an 80-hour automatic movement.',
    15,
    4.70,
    167,
    TRUE,
...
(
    ...
    1900000.00,
    NULL,
    '/assets/pexels-190819.jpeg',
    '100m',
    '2 Years',
    '44mm',
    'Iconic Italian dive watch with luminous numerals and crown guard.',
    5,
    4.70,
    106,
    FALSE,
...
(
    ...
    255000.00,
    NULL,
    '/assets/pexels-87701.jpeg',
    '50m',
    '2 Years',
    '45mm',
    'Luxury connected smartwatch with high-end sensors and display.',
    18,
    4.60,
    201,
    FALSE,
